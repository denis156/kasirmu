<div>
    <!-- HEADER -->
    <x-header title="Laporan Penjualan" subtitle="Analisis dan statistik penjualan toko • Beta Version - Sedang dikembangkan" icon="phosphor.chart-line"
    ...
    <x-card title="Ringkasan Penjualan" subtitle="Statistik periode yang dipilih" shadow
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
            ...
            <x-stat
                ...
                value="{{ number_format($this->summaryStats()['total_items']) }}"
